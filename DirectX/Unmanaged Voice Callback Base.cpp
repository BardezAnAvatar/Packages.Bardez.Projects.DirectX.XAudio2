...
{
	this->managedCallback->OnBufferEnd(System::IntPtr(bufferContext));
}
...
{
	this->managedCallback->OnBufferStart(System::IntPtr(bufferContext));
}
...
{
	this->managedCallback->OnVoiceError(System::IntPtr(bufferContext), (ResultCode)error);
}
...
{
	this->managedCallback->OnVoiceProcessingPassEnd();
}
...
{
	this->managedCallback->OnVoiceProcessingPassStart(bytesRequired);
}
#pragma endregion
