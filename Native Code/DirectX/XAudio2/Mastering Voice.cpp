...
{
	// Dispose this voice
	if (this->XAudio2MasteringVoice)
	{
		this->XAudio2MasteringVoice->DestroyVoice();
		this->XAudio2MasteringVoice = NULL;
	}
}
#pragma endregion
...
ResultCode MasteringVoice::DisableEffect(System::UInt32 effectIndex, System::UInt32 operationSet)
{
	return (ResultCode)this->XAudio2MasteringVoice->DisableEffect(effectIndex, operationSet);
}
...
/// <param name="operationSet">Operation set of the effect (XAUDIO2_COMMIT_NOW == 0?), identifiying a batch</param>
/// <returns>A ResultCode indicating the result of the operation</returns>
ResultCode MasteringVoice::EnableEffect(System::UInt32 effectIndex, System::UInt32 operationSet)
{
	return (ResultCode)this->XAudio2MasteringVoice->EnableEffect(effectIndex, operationSet);
}
...
array<System::Single>^ MasteringVoice::GetChannelVolumes(System::UInt32 channels)
{
	...
	this->XAudio2MasteringVoice->GetChannelVolumes(channels, volumes);
...
System::Boolean MasteringVoice::GetEffectState(System::UInt32 effectIndex)
{
	BOOL enabled;
	this->XAudio2MasteringVoice->GetEffectState(effectIndex, &enabled);
...
FilterParameter^ MasteringVoice::GetFilterParameters()
{
	XAUDIO2_FILTER_PARAMETERS parameters;
	this->XAudio2MasteringVoice->GetFilterParameters(&parameters);
...
{
	XAUDIO2_FILTER_PARAMETERS parameters;
	this->XAudio2MasteringVoice->GetOutputFilterParameters(destination->XAudio2Voice, &parameters);
	return gcnew FilterParameter(parameters);
}
...
array<System::Single>^ MasteringVoice::GetOutputMatrix(Voice^ destination, System::UInt32 sourceChannels, System::UInt32 destinationChannels)
{
	...
	this->XAudio2MasteringVoice->GetOutputMatrix(destination->XAudio2Voice, sourceChannels, destinationChannels, matrix);
...
VoiceDetails^ MasteringVoice::GetVoiceDetails()
{
	XAUDIO2_VOICE_DETAILS details;
	this->XAudio2MasteringVoice->GetVoiceDetails(&details);
...
/// </remarks>
System::Single MasteringVoice::GetVolume()
{
	float volume;
	this->XAudio2MasteringVoice->GetVolume(&volume);
	return volume;
}
...
ResultCode MasteringVoice::SetChannelVolumes(array<System::Single>^ volumes, System::UInt32 operationSet)
{
	...
	return (ResultCode)this->XAudio2MasteringVoice->SetChannelVolumes(volumes->Length, unmanagedVol, operationSet);
}
...
/// </remarks>
ResultCode MasteringVoice::SetEffectChain(System::Collections::Generic::List<EffectDescriptor^>^ chain)
{
	this->effects = chain;
	ResultCode result;
	...
	else
	{
		...
		result = (ResultCode)this->XAudio2MasteringVoice->SetEffectChain(&effectChain);
	}
...
{
	return (ResultCode)this->XAudio2MasteringVoice->SetFilterParameters(&(parameter->ToUnmanaged()), operationSet);
}
...
{
	return (ResultCode)this->XAudio2MasteringVoice->SetOutputFilterParameters(destination->XAudio2Voice, &(parameter->ToUnmanaged()), operationSet);
}
...
ResultCode MasteringVoice::SetOutputMatrix(Voice^ destination, System::UInt32 sourceChannels, System::UInt32 destinationChannels, array<System::Single>^ volumeMatrix, System::UInt32 operationSet)
{
	...
	return (ResultCode)this->XAudio2MasteringVoice->SetOutputMatrix(destination->XAudio2Voice, sourceChannels, destinationChannels, unmanagedVol, operationSet);
}
...
ResultCode MasteringVoice::SetOutputVoices(array<VoiceSendDescriptor^>^ voices)
{
	...
	return (ResultCode)this->XAudio2MasteringVoice->SetOutputVoices(&sendList);
}
...
/// </remarks>
ResultCode MasteringVoice::SetVolume(System::Single volume, System::UInt32 operationSet)
{
	return (ResultCode)this->XAudio2MasteringVoice->SetVolume(volume, operationSet);
}
